export default {
  auth: {
		...
		forgetPassword:"忘记密码",
		loginSuccess:"登录成功",
		emailFormatError:"账号格式不正确",
		emailOrPwdEmpty:"邮箱或者密码不能为空",
		logout:"退出",
		code:"验证码",
		getCode:"获取验证码",
		codeEmpty:"验证码不能为空",
  ...
  mj:{
    ...
    ,upImg:'<p class="pt-2"><b>上传excel表格</b> <br>文件格式：xls、xlsx、csv</p>'
    ,clearAll:'清参数'
    ,czoom:'自定义'
    ,customTitle:'自定义变焦'
